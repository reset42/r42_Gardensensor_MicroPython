...
PASSWORD       = "5667361407102283a!"          # Passwort des primären WLANs / Primary WiFi password
...
NTP_SERVER     = "192.168.178.1"           # Öffentlicher NTP-Server / Public NTP server
...
WIFI_CONNECT_TIMEOUT = 3  				  # Sekunden für WLAN-Timeout (Empfohlen: 3–5)
...
MQTT_USER           = None                # z. B. "sensoruser" / Example: "sensoruser"
MQTT_PASSWORD       = None                # z. B. "geheim123" / Example: "secret123"
...
VEML7700_IT         = 25                 # Integrationszeit: 25, 50, 100, 200, 400, 800 / Integration time
